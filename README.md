...
```bash
python3 save_preds.py --checkpoint_path "./models/transduction_model/<same_model_as_testset>.pt" --mel_spectrogram --normalizers_file "normalizers_mel_spec.pkl" --amp --model_size 512 --num_layers 3 --testset_file "<same_testset_as_model>.json" --recon_loss_weight 0.0
```